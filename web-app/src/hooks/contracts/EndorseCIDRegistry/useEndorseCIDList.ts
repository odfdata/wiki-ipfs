...
export interface UseEndorseCIDListParams {
  CIDList: string[]
}
 ...
 */
export const useEndorseCIDList = (params: UseEndorseCIDListParams): useBaseSmartContractWriteExternalReturn<undefined> => {
